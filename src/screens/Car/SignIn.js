                            ...
                            <HStack space={2}>
                                <Checkbox
                                    ...
                                    style={{
                                        ...
                                        borderStyle: 'solid',
                                        borderWidth: 1.5,
                                        borderColor: COLOR.inIconColor,
                                        borderRadius: 3,
                                    }}
                                />
                                <Text fontWeight="semibold" fontSize="2xs">Remember me</Text>
                            </HStack>
                            <TouchableOpacity onPress={goForgotPass}>
                                <Text color={COLOR.IBase} fontWeight="semibold" fontSize="2xs">Forgot password?</Text>
                            </TouchableOpacity>
                        </HStack>
                    </VStack>
                    <Box mt={7}>
