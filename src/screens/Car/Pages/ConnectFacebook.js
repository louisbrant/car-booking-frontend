...
const ConnectFacebookPage = ({ navigation }) => {
                ...
                <VStack space={2}>
                    <Box py={3}>
                        <Text color={COLOR.inPlaceholder} fontWeight="medium" fontSize="2xs">
                            Connect your Facebook account to log in more easily, see mutual friends, automatically update your profile photo and more.
                        </Text>
                    </Box>
                    <Box>
                        <TouchableOpacity>
